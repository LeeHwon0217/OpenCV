...
# 특히 이진 영상, 흑백 영상에서 물체의 외관선 크기, 형태를 변경하거나 분석하는 데 사용
...
# MORPH_RECT: 사각형, MORPH_ELLIPSE: 타원형, MORPH_CROSS: 십자형
# gse = cv2.getStructuringElement(cv2.MORPH_RECT, (3, 3))
# gse = cv2.getStructuringElement(cv2.MORPH_RECT, (5, 5))  # 훨씬 더 그거됨
